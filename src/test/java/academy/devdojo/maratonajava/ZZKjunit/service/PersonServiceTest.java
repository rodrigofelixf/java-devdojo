package academy.devdojo.maratonajava.ZZKjunit.service;
...
class PersonServiceTest {
    ...
    void isAdult_ReturnTrue_WhenAgeIsLowerThan18() {
    ...
    void filterRemovingNotAdult_ReturnListAdultOnly_WhenListOfPersonWithAdultIsPassed() {
